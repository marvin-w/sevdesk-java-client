...
/**
 * API tests for CheckAccountApi
 */
@Ignore
public class CheckAccountApiTest {

    private final CheckAccountApi api = new CheckAccountApi();
    ...
    public void checkAccountTransferTest() throws ApiException {
        ...
        String date = null;
        api.checkAccountTransfer(id, amount, targetId, targetObjectName, date);
    ...
    public void getCheckAccountsTest() throws ApiException {
        ...
        ModelDiscounts response = api.getCheckAccounts(limit, offset, embed);
