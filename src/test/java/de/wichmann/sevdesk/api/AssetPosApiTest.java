...
/**
 * API tests for AssetPosApi
 */
@Ignore
public class AssetPosApiTest {

    private final AssetPosApi api = new AssetPosApi();
    ...
    public void getAssetPositionsTest() throws ApiException {
        ...
        ModelAssetPos response = api.getAssetPositions(limit, offset, embed);
