...
/**
 * API tests for AccountingSystemNumberApi
 */
@Ignore
public class AccountingSystemNumberApiTest {

    private final AccountingSystemNumberApi api = new AccountingSystemNumberApi();
    ...
    public void getAccountingSystemNumbersTest() throws ApiException {
        ...
        ModelAccountingSystemNumber response = api.getAccountingSystemNumbers(limit, offset, embed);
