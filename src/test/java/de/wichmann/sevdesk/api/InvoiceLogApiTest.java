...
/**
 * API tests for InvoiceLogApi
 */
@Ignore
public class InvoiceLogApiTest {

    private final InvoiceLogApi api = new InvoiceLogApi();
    ...
    public void getInvoiceLogsTest() {
        ...
        ModelInvoiceLog response = api.getInvoiceLogs(limit, offset, embed);
