...
/**
 * API tests for PartContactPriceApi
 */
@Ignore
public class PartContactPriceApiTest {

    private final PartContactPriceApi api = new PartContactPriceApi();
    ...
    public void getPartContactPricesTest() {
        ...
        ModelPartContactPrice response = api.getPartContactPrices(limit, offset, embed);
