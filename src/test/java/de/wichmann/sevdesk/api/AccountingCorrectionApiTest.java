...
/**
 * API tests for AccountingCorrectionApi
 */
@Ignore
public class AccountingCorrectionApiTest {

    private final AccountingCorrectionApi api = new AccountingCorrectionApi();
    ...
    public void getAccountingCorrectionsTest() {
        ...
        ModelAccountingCorrection response = api.getAccountingCorrections(limit, offset, embed);
