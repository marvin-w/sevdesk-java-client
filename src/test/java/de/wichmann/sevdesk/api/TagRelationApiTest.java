...
/**
 * API tests for TagRelationApi
 */
@Ignore
public class TagRelationApiTest {

    private final TagRelationApi api = new TagRelationApi();
    ...
    public void getTagRelationsTest() {
        ...
        ModelTagRelation response = api.getTagRelations(limit, offset, embed);
