...
/**
 * API tests for AccountingContactApi
 */
@Ignore
public class AccountingContactApiTest {

    private final AccountingContactApi api = new AccountingContactApi();
    ...
    public void accountingContactIsAvailableDebitorCreditorNumberTest() throws ApiException {
        ...
        String creditorNumber = null;
        api.accountingContactIsAvailableDebitorCreditorNumber(contactId, contactObjectName, debitorNumber, creditorNumber);
    ...
    public void getAccountingContactsTest() throws ApiException {
        ...
        ModelAccountingContact response = api.getAccountingContacts(limit, offset, embed);
