...
/**
 * API tests for AccountingIndexApi
 */
@Ignore
public class AccountingIndexApiTest {

    private final AccountingIndexApi api = new AccountingIndexApi();
    ...
    public void getAccountingIndexesTest() throws ApiException {
        ...
        ModelAccountingIndex response = api.getAccountingIndexes(limit, offset, embed);
