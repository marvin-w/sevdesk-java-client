...
/**
 * API tests for ObjectViewedApi
 */
@Ignore
public class ObjectViewedApiTest {

    private final ObjectViewedApi api = new ObjectViewedApi();
    ...
    public void getObjectViewedTest() throws ApiException {
        ...
        ModelObjectViewed response = api.getObjectViewed(limit, offset, embed);
