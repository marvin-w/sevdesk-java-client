...
/**
 * API tests for PartUnityApi
 */
@Ignore
public class PartUnityApiTest {

    private final PartUnityApi api = new PartUnityApi();
    ...
    public void getPartUnitiesTest() throws ApiException {
        ...
        ModelPartUnity response = api.getPartUnities(limit, offset, embed);
