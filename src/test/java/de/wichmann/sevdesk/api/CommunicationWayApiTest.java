...
/**
 * API tests for CommunicationWayApi
 */
@Ignore
public class CommunicationWayApiTest {

    private final CommunicationWayApi api = new CommunicationWayApi();
    ...
    public void getCommunicationWaysTest() {
        ...
        ModelCommunicationWay response = api.getCommunicationWays(limit, offset, embed);
