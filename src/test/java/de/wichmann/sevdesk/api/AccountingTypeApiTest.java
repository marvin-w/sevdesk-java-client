...
/**
 * API tests for AccountingTypeApi
 */
@Ignore
public class AccountingTypeApiTest {

    private final AccountingTypeApi api = new AccountingTypeApi();
    ...
    public void getAccountingTypesTest() {
        ...
        Integer offset = null;
        List<String> embed = null;
        ModelAccountingType response = api.getAccountingTypes(limit, offset, embed);
