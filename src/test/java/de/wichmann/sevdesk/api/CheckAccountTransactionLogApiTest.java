...
/**
 * API tests for CheckAccountTransactionLogApi
 */
@Ignore
public class CheckAccountTransactionLogApiTest {

    private final CheckAccountTransactionLogApi api = new CheckAccountTransactionLogApi();
    ...
    public void getCheckAccountTransactionLogTest() throws ApiException {
        ...
        ModelCheckAccountTransactionLog response = api.getCheckAccountTransactionLog(limit, offset, embed);
