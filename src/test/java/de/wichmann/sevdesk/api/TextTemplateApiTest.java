...
/**
 * API tests for TextTemplateApi
 */
@Ignore
public class TextTemplateApiTest {

    private final TextTemplateApi api = new TextTemplateApi();
    ...
    public void getTextTemplateTest() {
        ...
        ModelTextTemplate response = api.getTextTemplate(limit, offset, embed);
