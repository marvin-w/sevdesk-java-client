...
/**
 * API tests for VatReportApi
 */
@Ignore
public class VatReportApiTest {

    private final VatReportApi api = new VatReportApi();
    ...
    public void getVatReportTest() throws ApiException {
        ...
        api.getVatReport(reportingYear, reportingPeriodCode, noActualTaxationOnInputTax);
