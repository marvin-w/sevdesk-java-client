...
/**
 * API tests for VoucherPosApi
 */
@Ignore
public class VoucherPosApiTest {

    private final VoucherPosApi api = new VoucherPosApi();
    ...
    public void getVoucherPositionsTest() throws ApiException {
        ...
        ModelVoucherPos response = api.getVoucherPositions(limit, offset, embed);
