...
/**
 * API tests for ContactAddressApi
 */
@Ignore
public class ContactAddressApiTest {

    private final ContactAddressApi api = new ContactAddressApi();
    ...
    public void getContactAddressesTest() throws ApiException {
        ...
        ModelContactAddress response = api.getContactAddresses(limit, offset, embed);
