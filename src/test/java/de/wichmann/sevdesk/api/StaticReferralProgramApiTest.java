...
/**
 * API tests for StaticReferralProgramApi
 */
@Ignore
public class StaticReferralProgramApiTest {

    private final StaticReferralProgramApi api = new StaticReferralProgramApi();
