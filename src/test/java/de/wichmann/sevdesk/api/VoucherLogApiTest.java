...
/**
 * API tests for VoucherLogApi
 */
@Ignore
public class VoucherLogApiTest {

    private final VoucherLogApi api = new VoucherLogApi();
    ...
    public void getVoucherLogTest() {
        ...
        ModelVoucherLog response = api.getVoucherLog(limit, offset, embed);
