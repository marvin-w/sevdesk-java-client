...
/**
 * API tests for OrderLogApi
 */
@Ignore
public class OrderLogApiTest {

    private final OrderLogApi api = new OrderLogApi();
    ...
    public void getOrderLogsTest() throws ApiException {
        ...
        ModelOrderLog response = api.getOrderLogs(limit, offset, embed);
