...
/**
 * API tests for InventoryPartLogApi
 */
@Ignore
public class InventoryPartLogApiTest {

    private final InventoryPartLogApi api = new InventoryPartLogApi();
    ...
    public void getInventoryPartLogTest() throws ApiException {
        ...
        ModelInventoryPartLog response = api.getInventoryPartLog(limit, offset, embed);
