...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-26T00:13:41.764+02:00[Europe/Berlin]")public class SevUserApi {
   ...
   */
  public ModelSevUser getSevUser(List<String> embed) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/SevUser".replaceAll("\\{format\\}","json");
    ...
    GenericType<ModelSevUser> localVarReturnType = new GenericType<ModelSevUser>() {};
   ...
   * @throws ApiException if fails to make API call
   */
  public void sevUserGetApiToken() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/SevUser/getApiToken".replaceAll("\\{format\\}","json");
