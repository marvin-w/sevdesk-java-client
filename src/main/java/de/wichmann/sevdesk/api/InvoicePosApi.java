...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-26T00:13:41.764+02:00[Europe/Berlin]")public class InvoicePosApi {
   ...
   */
  public ModelInvoicePos addInvoicePos() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/InvoicePos".replaceAll("\\{format\\}","json");
   ...
   * @param id id of invoice position you want to delete (required)
   * @throws ApiException if fails to make API call
   */
  public void deleteInvoicePos(Integer id) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deleteInvoicePos");
    }
    // create path and map variables
    String localVarPath = "/InvoicePos/{id}".replaceAll("\\{format\\}","json")
   ...
   * @throws ApiException if fails to make API call
   */
  public ModelInvoicePos getInvoicePositions(Integer limit, Integer offset, List<String> embed) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/InvoicePos".replaceAll("\\{format\\}","json");
   ...
   * @param id id of invoice position you want to update (required)
   * @return ModelInvoicePos
   * @throws ApiException if fails to make API call
   */
  public ModelInvoicePos updateInvoicePos(Integer id) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling updateInvoicePos");
    }
    // create path and map variables
    String localVarPath = "/InvoicePos/{id}".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
