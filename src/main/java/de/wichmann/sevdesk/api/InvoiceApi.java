...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-26T00:58:42.052+02:00[Europe/Berlin]")@Component("de.wichmann.sevdesk.api.InvoiceApi")
public class InvoiceApi {
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice which you want to cancel
     * @return ModelInvoice
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoice cancelInvoice(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling cancelInvoice");
        }
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id id of invoice you want to delete
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void deleteInvoice(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling deleteInvoice");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id id of invoice you want to duplicate
     * @return ModelInvoice
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoice duplicateInvoice(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling duplicateInvoice");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param invoiceId id of the invoice you want to get the total amount for
     * @param invoiceObjectName The invoiceObjectName parameter
     * @return Object
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Object getInvoiceAndReminderAmount(Integer invoiceId, String invoiceObjectName) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'invoiceId' is set
        if (invoiceId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'invoiceId' when calling getInvoiceAndReminderAmount");
        }
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the PDF
    ...
    public Byte[] getInvoiceAsPdf(Integer id, Boolean download) throws RestClientException {
        ...
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling getInvoiceAsPdf");
        }
        // verify the required parameter 'download' is set
        if (download == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'download' when calling getInvoiceAsPdf");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param invoiceId id of the invoice you want to get the reminder amount for
     * @param invoiceObjectName The invoiceObjectName parameter
     * @return Object
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Object getInvoiceReminderAmount(Integer invoiceId, String invoiceObjectName) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'invoiceId' is set
        if (invoiceId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'invoiceId' when calling getInvoiceReminderAmount");
        }
        // verify the required parameter 'invoiceObjectName' is set
        if (invoiceObjectName == null) {
     ...
     * @param offset Set the index where the returned invoices start. Default is 0
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param invoiceType defines the type of invoice you want to get the next number from
     * @param useNextNumber By default this is true, so the invoiceNumber will increase by one otherwise the invoiceNumber will not change
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void getNextInvoiceNumber(String invoiceType, Boolean useNextNumber) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'invoiceType' is set
        if (invoiceType == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'invoiceType' when calling getNextInvoiceNumber");
        }
        ...
        final HttpHeaders headerParams = new HttpHeaders();
        final MultiValueMap<String, Object> formParams = new LinkedMultiValueMap<String, Object>();
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "invoiceType", invoiceType));
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "useNextNumber", useNextNumber));
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id id of invoice you want to add a position to
     * @return ModelInvoice
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoice invoiceAddPosition(Integer id, MultiValueMap<String, Object> params) throws RestClientException {
        ...
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceAddPosition");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to book an amount
     * @param ammount amount which should be booked
     * @param date booking date
     * @return ModelInvoiceLog
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoiceLog invoiceBookAmount(Integer id, Integer ammount, String date) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceBookAmount");
        }
        // verify the required parameter 'ammount' is set
        if (ammount == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'ammount' when calling invoiceBookAmount");
        }
        // verify the required parameter 'date' is set
        if (date == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'date' when calling invoiceBookAmount");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        ...
        ParameterizedTypeReference<ModelInvoiceLog> returnType = new ParameterizedTypeReference<ModelInvoiceLog>() {};
        return apiClient.invokeAPI(path, HttpMethod.PUT, queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
    }
    /**
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the dunning level
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceCalculateDunningLevel(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceCalculateDunningLevel");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoice invoiceChangeStatus(Integer id, Integer value) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceChangeStatus");
        }
        // verify the required parameter 'value' is set
        if (value == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'value' when calling invoiceChangeStatus");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to know if it is cancled
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetCancled(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetCancled");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of the invoice of which you want to get the check account transaction logs
     * @param embed Get some additional information. Embed can handle multiple values, they must be separated by comma. Default &#x60;&#x60;.
     * @return ModelCheckAccountTransactionLog
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelCheckAccountTransactionLog invoiceGetCheckAccountTransactionLogs(Integer id, List<String> embed) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetCheckAccountTransactionLogs");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of the invoice of which you want to get the check account transactions
     * @param embed Get some additional information. Embed can handle multiple values, they must be separated by comma. Default &#x60;&#x60;.
     * @return ModelCheckAccountTransaction
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelCheckAccountTransaction invoiceGetCheckAccountTransactions(Integer id, List<String> embed) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetCheckAccountTransactions");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the debit
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetDebit(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetDebit");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to know if its delinquent
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetDelinquent(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetDelinquent");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the discounts
     * @param embed Get some additional information. Embed can handle multiple values, they must be separated by comma. Default &#x60;&#x60;.
     * @return ModelDiscounts
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelDiscounts invoiceGetDiscounts(Integer id, List<String> embed) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetDiscounts");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the document
     * @param embed Get some additional information. Embed can handle multiple values, they must be separated by comma. Default &#x60;&#x60;.
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetDocument(Integer id, List<String> embed) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetDocument");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the dunnings
     * @return ModelInvoice
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoice invoiceGetDunnings(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetDunnings");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the feed
     * @param embed Get some additional information. Embed can handle multiple values, they must be separated by comma. Default &#x60;&#x60;.
     * @return ModelFeed
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelFeed invoiceGetFeed(Integer id, List<String> embed) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetFeed");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of the invoice of which you want to get the final invoice id
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetFinalInvoiceId(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetFinalInvoiceId");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to know if it is partially paid
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetIsPartiallyPaid(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetIsPartiallyPaid");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the date of the last dunning
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetLastDunningDate(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetLastDunningDate");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of the invoice of which you want to get the partial invoices
     * @param embed Get some additional information. Embed can handle multiple values, they must be separated by comma. Default &#x60;&#x60;.
     * @return ModelInvoice
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoice invoiceGetPartialInvoices(Integer id, List<String> embed) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetPartialInvoices");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the positions
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoicePos invoiceGetPositions(Integer id, Integer limit, Integer offset, List<String> embed) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetPositions");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        ...
        ParameterizedTypeReference<ModelInvoicePos> returnType = new ParameterizedTypeReference<ModelInvoicePos>() {};
        return apiClient.invokeAPI(path, HttpMethod.GET, queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
    }
    /**
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of the invoice of which you want to get the related objects
     * @param includeItself Define if the related objects include the invoice itself
     * @param sortByType Define if you want the related objects sorted by type
     * @param embed Get some additional information. Embed can handle multiple values, they must be separated by comma. Default &#x60;&#x60;.
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetRelatedObjects(Integer id, Boolean includeItself, Boolean sortByType, List<String> embed) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetRelatedObjects");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        ...
        final HttpHeaders headerParams = new HttpHeaders();
        final MultiValueMap<String, Object> formParams = new LinkedMultiValueMap<String, Object>();
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "includeItself", includeItself));
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "sortByType", sortByType));
        queryParams.putAll(apiClient.parameterToMultiValueMap(ApiClient.CollectionFormat.valueOf("csv".toUpperCase()), "embed", embed));
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the tags
     * @param embed Get some additional information. Embed can handle multiple values, they must be separated by comma. Default &#x60;&#x60;.
     * @return ModelTag
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelTag invoiceGetTags(Integer id, List<String> embed) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetTags");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the invoice tax amount
     * @param invoiceAmount Determines whether to use sumTax from invoice or sumTaxAccounting
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetTax(Integer id, Boolean invoiceAmount) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetTax");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the tax groups
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetTaxGroups(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetTaxGroups");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the gross invoice amount
     * @param invoiceAmount Determines whether to use sumGross from invoice or sumGrossAccounting
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetTotal(Integer id, Boolean invoiceAmount) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetTotal");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the invoice amount in invoice currency
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetTotalCalc(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetTotalCalc");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to get the total net invoice amount
     * @param invoiceAmount Determines whether to use sumNet from invoice or sumNetAccounting
     * @param withoutDiscounts Determines whether the total net is calculated with or without the discounts
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceGetTotalNet(Integer id, Boolean invoiceAmount, Boolean withoutDiscounts) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceGetTotalNet");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        ...
        final MultiValueMap<String, Object> formParams = new LinkedMultiValueMap<String, Object>();
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "invoiceAmount", invoiceAmount));
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "withoutDiscounts", withoutDiscounts));
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to know if it has discounts
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceHasDiscounts(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceHasDiscounts");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to know if it is the origin of an order
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void invoiceIsOrigin(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceIsOrigin");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice which you want to mark as sent
     * @return ModelInvoice
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoice invoiceMarkAsSent(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceMarkAsSent");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice of which you want to refund the amount
     * @param ammount amount which should be refunded
     * @param date booking date
     * @return ModelInvoice
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoice invoiceRefundAmount(Integer id, Integer ammount, String date) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceRefundAmount");
        }
        // verify the required parameter 'ammount' is set
        if (ammount == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'ammount' when calling invoiceRefundAmount");
        }
        // verify the required parameter 'date' is set
        if (date == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'date' when calling invoiceRefundAmount");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
    ...
    public void invoiceRender(Integer id) throws RestClientException {
        ...
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceRender");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id Id of invoice which you want to send
     * @param sendType desired send type, available are: VM &#x3D; Mail, VP &#x3D; Post, VPDF &#x3D; PDF, PRN &#x3D; Print
     * @return ModelInvoice
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoice invoiceSendBy(Integer id, String sendType) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling invoiceSendBy");
        }
        // verify the required parameter 'sendType' is set
        if (sendType == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'sendType' when calling invoiceSendBy");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
    ...
    public ModelInvoiceFactory saveInvoice(MultiValueMap<String, Object> params) throws RestClientException {
        ...
        ParameterizedTypeReference<ModelInvoiceFactory> returnType = new ParameterizedTypeReference<ModelInvoiceFactory>() {};
        return apiClient.invokeAPI(path, HttpMethod.POST, queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
    }
    /**
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id id of invoice you want to send via Email
     * @return ModelEmail
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelEmail sendInvoiceViaEmail(Integer id) throws RestClientException {
        ...
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling sendInvoiceViaEmail");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id id of invoice you want to send via Letter
     * @return ModelInvoice
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoice sendInvoiceViaPost(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling sendInvoiceViaPost");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
     ...
     * <p><b>400</b> - invalid request
     * <p><b>401</b> - authentication required
     * @param id id of invoice you want to update
     * @return ModelInvoice
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ModelInvoice updateInvoice(Integer id) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling updateInvoice");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
