...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-26T00:13:41.764+02:00[Europe/Berlin]")public class TaskApi {
   ...
   */
  public ModelOrderPos addTask() throws ApiException {
   ...
   * @param id id of the task you want to delete (required)
   * @throws ApiException if fails to make API call
   */
  public void deleteTask(Integer id) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @param offset Set the index where the returned tasks start. Default is 0 (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public ModelTask getTasks(Integer limit, Integer offset, List<String> embed) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/Task".replaceAll("\\{format\\}","json");
    ...
    GenericType<ModelTask> localVarReturnType = new GenericType<ModelTask>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
  /**
   * Update an existing Task
   * TODO: Enter short backend documentation here
   * @param id id of task you want to update (required)
   * @return ModelTask
   * @throws ApiException if fails to make API call
   */
  public ModelTask updateTask(Integer id) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
