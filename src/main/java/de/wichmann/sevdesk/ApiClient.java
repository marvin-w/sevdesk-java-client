...
import de.wichmann.sevdesk.auth.HttpBasicAuth;
import de.wichmann.sevdesk.auth.OAuth;


@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-26T00:58:42.052+02:00[Europe/Berlin]") @Component("de.wichmann.sevdesk.ApiClient")
public class ApiClient
{
	...
	private String basePath = "https://my.sevdesk.de/api/v1";
	...
	protected void init()
	{
		...
		authentications.put("api_key", new ApiKeyAuth("query", "token"));
	...
	{
		boolean isForm = MediaType.MULTIPART_FORM_DATA.isCompatibleWith(contentType) || MediaType.APPLICATION_FORM_URLENCODED
	...
	public <T> T invokeAPI(String path, HttpMethod method, MultiValueMap<String, String> queryParams, Object body,
			HttpHeaders headerParams, MultiValueMap<String, Object> formParams, List<MediaType> accept, MediaType contentType,
