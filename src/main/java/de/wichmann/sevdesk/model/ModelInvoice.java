...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-26T00:13:41.764+02:00[Europe/Berlin]")public class ModelInvoice {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(invoiceNumber, contact, create, update, invoiceDate, header, headText, footText, timeToPay, discountTime, discount, addressName, addressStreet, addressZip, addressCity, addressCountry, payDate, createUser, sevClient, deliveryDate, status, smallSettlement, contactPerson, taxRate, taxText, dunningLevel, addressParentName, addressContactRef, taxType, paymentMethod, costCentre, sendDate, origin, invoiceType, accountIntervall, accountLastInvoice, accountNextInvoice, reminderTotal, reminderDebit, reminderDeadline, reminderCharge, addressParentName2, addressName2, taxSet, addressGender, accountEndDate, address, currency, sumNet, sumTax, sumGross, sumDiscounts, sumNetForeignCurrency, sumTaxForeignCurrency, sumGrossForeignCurrency, sumDiscountsForeignCurrency, sumNetAccounting, sumTaxAccounting, sumGrossAccounting, entryType, costumerInternalNote, showNet, enshrined, sendType, deliveryDateUntil);
  }
